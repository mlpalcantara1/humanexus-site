const EQUIVALENCIAS_EXATAS: Record<string, string> = {
  ...
  LIVE: "AO VIVO",
  LOADING: "CARREGANDO",
  "ADMINISTRADOR PROPRIETARIO": "ADMINISTRADOR PROPRIETÁRIO",
  "COLETIVO EM FORMACAO": "COLETIVO EM FORMAÇÃO",
  "AGUARDANDO CONSOLIDACAO PROFISSIONAL": "AGUARDANDO CONSOLIDAÇÃO PROFISSIONAL",
  "EVIDENCIA TEMPORAL AINDA INSUFICIENTE": "EVIDÊNCIA TEMPORAL AINDA INSUFICIENTE",
  "INICIAR PRE": "INICIAR PRÉ",
  "LIMIAR DE ANONIMIZACAO NAO AUTORIZADO": "LIMIAR DE ANONIMIZAÇÃO NÃO AUTORIZADO",
  "NAO CALCULAVEL": "NÃO CALCULÁVEL",
  "NAO CLASSIFICAVEL": "NÃO CLASSIFICÁVEL",
  ...
  PERSON: "PESSOA",
  "PERMISSOES DE EXPOSICAO COLETIVA INCOMPLETAS": "PERMISSÕES DE EXPOSIÇÃO COLETIVA INCOMPLETAS",
  "PRONTO PARA VALIDACAO": "PRONTO PARA VALIDAÇÃO",
  "RASCUNHO TECNICO": "RASCUNHO TÉCNICO",
  STATUS: "SITUAÇÃO",
  SUCCESS: "SUCESSO",
  VALIDATED: "VALIDADO"
};
...
const SUBSTITUICOES_VISIVEIS: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  [/\bparticipant_self_report\b/gi, "autorrelato do participante"],
  [/\bperfil_operacional\b/gi, "perfil operacional"],
  [/\btrace de sessão\b/gi, "rastreamento da sessão"],
  ...
  [/\bnao\b/gi, "não"],
  [/\bcalculavel\b/gi, "calculável"],
  [/\bclassificavel\b/gi, "classificável"],
  [/\belegivel\b/gi, "elegível"],
  [/\bevidencia\b/gi, "evidência"],
  [/\bevidencias\b/gi, "evidências"],
  [/\badmissiveis\b/gi, "admissíveis"],
  [/\bminimo\b/gi, "mínimo"],
  [/\bconfianca\b/gi, "confiança"],
  [/\bregulatoria\b/gi, "regulatória"],
  [/\bneuroregulatorio\b/gi, "neurorregulatório"],
  [/\btrajetoria\b/gi, "trajetória"],
  [/\bdisponivel\b/gi, "disponível"],
  [/\banonimizacao\b/gi, "anonimização"],
